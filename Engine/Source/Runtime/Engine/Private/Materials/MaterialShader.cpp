...
void UpdateMaterialShaderCompilingStats(const FMaterial* Material)
{
	...
	else if (ShadingModels.HasAnyShadingModel({ MSM_DefaultLit, MSM_Subsurface, MSM_PreintegratedSkin, MSM_ClearCoat, MSM_Cloth, MSM_SubsurfaceProfile, MSM_TwoSidedFoliage, MSM_SingleLayerWater, MSM_Toon, MSM_ToonSkin, MSM_ToonHair, MSM_ToonAniso, MSM_Anisotropic }))
	{
