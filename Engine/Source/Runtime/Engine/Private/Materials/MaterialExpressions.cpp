...
int32 UMaterialExpressionMakeMaterialAttributes::Compile(class FMaterialCompiler* Compiler, int32 OutputIndex) 
{
	...
	// Stylized Shading
	case MP_SpecularOffset: Ret = PixelDepthOffset.Compile(Compiler); Expression = SpecularOffset.Expression; break;
	case MP_SpecularRange: Ret = PixelDepthOffset.Compile(Compiler); Expression = SpecularRange.Expression; break;
	case MP_ShadowColor: Ret = PixelDepthOffset.Compile(Compiler); Expression = ShadowColor.Expression; break;
